...
class TestKeywordScreener:
    ...
    def test_exclusion_hard_reject(self):
        ...
        screening, should_include, reason = screener.screen_paper(
            ...
            abstract="A study of patient outcomes"
        )
    ...
    def test_inclusion_score_matching(self):
        ...
        screening, should_include, _ = screener.screen_paper(
            ...
            abstract="We studied agile teams using lean principles"
        )
    ...
    def test_implicit_study_type_detection(self):
        ...
        # Editorial paper
        screening1, should_include1, _ = screener.screen_paper(
            title="Editorial: Future of software engineering"
        )
        ...
        screening2, should_include2, _ = screener.screen_paper(
            title="Empirical study of agile adoption",
            abstract="We conducted a case study evaluation of agile teams"
        )
    ...
    def test_mode_inclusion_required(self):
        ...
        screening1, should_include1, _ = screener.screen_paper(
            title="Agile adoption in software teams"
        )
        ...
        screening2, should_include2, _ = screener.screen_paper(
            ...
            abstract="Medical teams using scrum"
        )
        assert should_include2 is False
        
        # No inclusion keywords → FAIL
        screening3, should_include3, _ = screener.screen_paper(
            title="Software teams work together"
        )
    ...
    def test_mode_soft(self):
        ...
        screening1, should_include1, _ = screener.screen_paper(
            title="Medical teams using agile"
        )
        assert should_include1 is True
    ...
    def test_study_type_exclusion(self):
        ...
        screening, should_include, reason = screener.screen_paper(
            title="Editorial: The future of AI"
        )
...
def run_manual_tests():
    ...
    screening2, include2, reason2 = screener.screen_paper(
        title="Agile adoption in healthcare systems",
        abstract="A medical study of scrum teams"
    )
