...
BIG_TEXT = (
    ...
    "**1.1. TITLE:** How do collaborative systems affect organizational "
    "agility and performance in supply chains?\n\n**1.2. AUTHORS:** Hangju "
    "Seo, Heejun Cho, Donghyuk Jo\n\n**1.3. YEAR:** 2025\n\n## 2. SUMMARY:\n"
    "This study examines the impact of collaborative systems (CS) quality on "
    "organizational agility and corporate performance within supply chain "
    "networks. The research focuses on how different quality dimensions of "
    "collaborative systems—system quality, information quality, and service "
    "quality—influence information collaboration and operational collaboration "
    "among supply chain partners. The authors argue that in the post-COVID "
    "era, organizations need enhanced collaborative systems to respond "
    "swiftly to environmental uncertainties and maintain competitive "
    "advantage.\n\n"
    "The study employs a quantitative approach using structural equation "
    "modeling (SEM) to analyze data from 344 South Korean companies with "
    "experience in integrated collaboration systems. The findings reveal that "
    "information quality is most crucial for information collaboration, while "
    "service quality significantly impacts operational collaboration. Both "
    "types of collaboration positively affect organizational agility and "
    "corporate performance, with operational collaboration showing stronger "
    "effects than information collaboration. The research provides valuable "
    "insights for organizations seeking to optimize their collaborative "
    "systems for improved supply chain performance.\n\n"
    "## 3. RESEARCH_QUESTION:\n"
    "How do collaborative systems quality factors affect organizational "
    "agility and corporate performance through information collaboration and "
    "operational collaboration in supply chain networks?\n\n"
    "## 4. METHODOLOGY:\n**4.1. EMPIRICAL_BASE:** Yes, the study has a strong "
    "empirical base with survey data collected from 344 South Korean companies "
    "from June to October 2023.\n\n"
    "**4.2. METHODOLOGY_CLASS:** Quantitative research using "
    "Covariance-Based Structural Equation Modeling (CB-SEM) with AMOS 27.0 "
    "software.\n\n## 5. VENDORS:\n**5.1. IT_SUPPLIER:** \n- Walmart's Retail "
    "Link (collaborative system platform)\n- Boeing's Exostar (collaborative "
    "system platform)\n- Procter & Gamble's CPFR system (collaborative "
    "planning, forecasting, and replenishment system)\n\n"
    "**5.2. REGULAR_SUPPLIER:**\n- No specific regular suppliers mentioned in "
    "the study; the focus is on supply chain partners in general rather than "
    "specific supplier companies\n\n## 6. INNOVATION_MECHANISMS:\n\n"
    "**6.1. CONTEXTS:**\n- Post-COVID pandemic business environment requiring "
    "enhanced digital collaboration\n- Rapidly evolving business conditions "
    "demanding swift organizational responses\n- Complex global supply chain "
    "networks requiring real-time coordination\n- Environmental uncertainty "
    "necessitating organizational agility\n- Digital transformation "
    "acceleration in supply chain management\n\n"
    "**6.2. MECHANISMS:**\n- **Information-Driven Collaboration:** Real-time "
    "data sharing and knowledge exchange between supply chain partners to "
    "enhance decision-making quality and reduce uncertainties\n"
    "- **System-Driven Integration:** Technical platform capabilities enabling "
    "seamless coordination and communication across supply chain networks\n"
    "- **Service-Driven Support:** User experience optimization through "
    "responsive problem-solving and platform convenience to facilitate "
    "operational workflows\n- **Collaboration-Driven Agility:** Joint "
    "operational processes and synchronized activities enabling rapid response "
    "to market changes and customer demands\n"
    "- **Quality-Driven Performance:** Comprehensive collaborative system "
    "quality encompassing technical, informational, and service dimensions to "
    "optimize organizational outcomes\n\n"
    "**6.3. OUTCOMES:**\n- **Enhanced Organizational Agility:** Improved "
    "ability to respond quickly to customer demands, launch new products "
    "rapidly, adjust production volumes, and handle operational problems\n"
    "- **Improved Corporate Performance:** Better product quality, on-time "
    "delivery performance, accurate quantity fulfillment, and higher partner "
    "satisfaction\n- **Operational Efficiency:** Reduced production and "
    "transportation times, cost savings, and enhanced competitiveness\n"
    "- **Supply Chain Resilience:** Better coordination among partners, "
    "reduced disruptions, and improved risk management capabilities\n"
    "- **Competitive Advantage:** Sustained market position through superior "
    "collaborative capabilities and responsive operations"
)
...
class TestAcademicPaperParser(unittest.TestCase):
    ...
    def test_extract_paper_header1(self):
        _INPUT = (
            "1.1. **TITLE:** How do collaborative systems affect organizational "
            "agility and performance in supply chains?\n\n1.2. **AUTHORS:** "
            "Hangju Seo, Heejun Cho, Donghyuk Jo\n\n1.3. **YEAR:** 2025\n\n"
        )
    ...
    def test_extract_paper_header2(self):
        _INPUT = (
            "## 1. PAPER_HEADER\n### 1.1. TITLE: Open innovation, digital "
            "transformation, the mediating effect of technological maturity "
            "and diversity\n\n### 1.2. AUTHORS: XiangYu Luan, XiaoHong Wang, "
            "Na Li\n\n### 1.3. YEAR: 2024\n\n"
        )
        ...
        self.assertEqual(
            result["TITLE"],
            "Open innovation, digital transformation, the mediating effect of technological maturity and diversity",
        )
    ...
    def test_innovation_mechanisms2(self):
        # Parse the input
        _INPUT = (
            "[High customer interaction with digital channels, FSP, Digital "
            "channel implementation, Enhanced customer experience but potential "
            "facade digitalization] - FSPs implement digital customer channels "
            "while maintaining legacy backend systems\n\n"
            "[Strategic cooperation with Fintech, FSP, Partnership formation, "
            "Access to digital products and services] - Insurance companies and "
            "banks form strategic partnerships with Fintech/Insurtech to offer "
            "innovative digital services\n\n"
            "[Digital strategy development, FSP management, Strategic planning "
            "and resource allocation, Systematic digital transformation "
            "approach] - FSPs develop dedicated digital strategies to guide "
            "comprehensive transformation efforts\n\n"
            "[Core system modernization, FSP with IT suppliers, Legacy system "
            "replacement or upgrade, Improved operational efficiency and "
            "digital capability] - Financial institutions work with technology "
            "providers to modernize core banking/insurance systems\n\n"
            "[Data analytics implementation, FSP with technology partners, "
            "Advanced analytics deployment, Enhanced customer insights and risk "
            "management] - FSPs implement big data and AI capabilities for "
            "strategic applications like fraud detection and personalized "
            "services\n\n"
            "[Platform ecosystem development, FSP with multiple partners, "
            "Multi-sided platform creation, New revenue streams and customer "
            "touchpoints] - Leading FSPs create platform ecosystems connecting "
            "multiple service providers and customers\n\n"
            "[Process digitalization, FSP with process automation vendors, "
            "Business process reengineering, Improved operational efficiency "
            "and customer experience] - FSPs digitalize their value creation "
            "processes to reduce manual interventions and improve service "
            "delivery"
        )
    ...
    def test_name1(self):
        _INPUT = (
            "# Academic Paper Analysis\n\n## 1. PAPER_HEADER:\n**1.1. TITLE:** "
            "Participatory design of digital innovation in agricultural "
            "research-for-development: insights from practice\n\n"
            "**1.2. AUTHORS:** Jonathan Steinke, Berta Ortiz-Crespo, Jacob van "
            "Etten, Anna Müller\n\n**1.3. YEAR:** 2022\n\n"
        )
        parsed_sections = self.parser.parse_sections(_INPUT)
        self.assertIn("PAPER_HEADER", parsed_sections)
    ...
    def test_name2(self):
        _INPUT = (
            ...
            "**AUTHORS**: Bård Tronvoll, Alexey Sklyar, David Sörhammar, "
    ...
    #     INPUT = (
    #         "## 9. IT_SUPPLIER\nYes. The article specifically focuses on IT "
    #         "Service Providers as external .\n\n"
    #     )
    #     parsed_sections = self.parser.parse_sections(INPUT)
